...
$yearData =$mysqli->query("SELECT year_of_study, COUNT(*) AS total FROM applications GROUP BY year_of_study");
$yearLabels = [];
$yearCounts = [];
...
<body>
    ...
    <div class="container mt-4">
        ...
        <div class="row mb-4">
            <div class="col-md-3">
                <div class="card bg-primary text-white p-3">Total applicationss: <?= $total ?></div>
            </div>
            <div class="col-md-3">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card p-3">
                    <h5 class="text-primary">Monthly applications Trend</h5>
                    <canvas id="areaChart"></canvas>
                </div>
            </div>
            <div class="col-md-6">
                <div class="card p-3">
                    <h5 class="text-primary">applicationss by Year of Study</h5>
